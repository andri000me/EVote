        ...
        <?php if($this->session->has_userdata('admin')): ?>
              ...
              <?= form_open_multipart('paslon/post', ['class' => 'form-horizontal']) ?>
                <?= validation_errors() ?>
                    ...
                    <?= form_input('nama_koalisi', $input->nama_koalisi, ['class' => 'form-control', 'placeholder' => 'UNG BERSATU']) ?>
								...
								<div class="form-group">
									...
									<div class="col-md-9">
                    <?= form_textarea('fakultas_koalisi', $input->fakultas_koalisi, ['class' => 'form-control', 'cols' => '2', 'row' => '2', 'placeholder' => 'Teknik, Ekonomi, Hukum, Pertanian dll..']) ?>
									</div>
								</div>
                ...
                <div class="form-group">
									...
									<div class="col-md-9">
                    <?= form_input('fakultas_capres', $input->fakultas_capres, ['class' => 'form-control', 'placeholder' => 'Teknik']) ?>
									</div>
								</div>
                <div class="form-group">
									<label class="col-md-3 control-label" for="name">Fakultas Cawapres</label>
									<div class="col-md-9">
                    <?= form_input('fakultas_cawapres', $input->fakultas_cawapres, ['class' => 'form-control', 'placeholder' => 'Ekonomi']) ?>
									</div>
								</div>
                <div class="form-group">
                ...
                <div class="form-group">
									...
									<div class="col-md-9">
                    <?= form_input('prodi_capres', $input->prodi_cawapres, ['class' => 'form-control', 'placeholder' => 'Sistem Informasi']) ?>
									</div>
								</div>
                <div class="form-group">
									<label class="col-md-3 control-label" for="name">Prodi Cawapres</label>
									<div class="col-md-9">
                    <?= form_input('prodi_cawapres', $input->prodi_cawapres, ['class' => 'form-control', 'placeholder' => 'Management']) ?>
									</div>
								</div>
                <div class="form-group">
